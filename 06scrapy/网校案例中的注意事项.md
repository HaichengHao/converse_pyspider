![](E:\converse_spider\converse_pyspider\06scrapy\ajax请求.png)

![](E:\converse_spider\converse_pyspider\06scrapy\类型.png)

## 构造最终的请求的时候需要将其补充headers的内容  
...
**注意** :在ajax的post请求当中，X-Requested-With，content-type经常会结伴出现