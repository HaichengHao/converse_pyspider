...
def dbverify(sql,params):
    conn=pymysql.connect(host='',port=3306,user='root',passwd='',charset='utf8',db='uandt',cursorclass=pymysql.cursors.DictCursor) #可以指定返回的是字典形式
    cursor = conn.cursour()
...
# http://127.0.0.1:5000/bili?token=fc4431fc-33e3-4d36-b1e0-a8d6934ebeb3 在postman发起请求