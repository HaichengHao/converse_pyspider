...
from myweb_optimize.views.login import login
from myweb_optimize.views.signup import signup
from myweb_optimize.views.index import index
from myweb_optimize.views.log_out import log_out
